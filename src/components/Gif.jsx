...
const Gif = ({gif,hover= true}) => {
  return (
    <Link to={`/${gif.type}s/${gif.slug}`} key={gif.id}>
        ...
        {hover && <div className="absolute inset-0 rounded opacity-0 group-hover:opacity-100  text-sm bg-gradient-to-b from-transparent via-transparent to-black font-bold flex items-end gap-2 p-2">
